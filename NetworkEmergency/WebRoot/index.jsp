...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <style type="text/css">
        ...
        .tyg-div-denglv{
            z-index:1000;float:right;position:absolute;right:8%;top:20%;
        }
        .tyg-div-form{
...
<div id="contPar" class="contPar">
    <div id="page1"  style="z-index:1;">
        <div class="title0">网络应急响应平台</div>
        <div class="title1">安全事件播报、热点事件发布、公共安全、大数据</div>
        <div class="imgGroug">
            <ul>
...
<div class="tyg-div-denglv">
    <div class="tyg-div-form">
        <form action="${pageContext.request.contextPath}/login.do" method="post">
            <h2>登录</h2><p class="tyg-p">欢迎访问  应急系统</p>
            <div style="margin:5px 0px;">
                <input type="text" placeholder="请输入账号..." name="account_number"/>
            </div>
            <div style="margin:5px 0px;">
                <input type="text" placeholder="请输入密码..." name="password"/>
            </div>
            <button type="submit" >登<span style="width:20px;"></span>录</a></button>
        </form>
    </div>
</div>
