...
<c:if test="${not empty addUser_ERROR2 }">
<script type="text/javascript">
	alert('${addUser_ERROR2}')
</script>
</c:if>
<body class="bg03">
    <div class="container">
        ...
        <div class="row tm-content-row tm-mt-big">
            ...
            <div class="tm-col tm-col-big">
                <div class="bg-white tm-block">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <form action="adduser.do" class="tm-signup-form">
                                <div class="form-group">
                                    <label for="name">Name</label>
                                    <input placeholder="please input name" id="name" name="user_name" type="text" class="form-control validate" required="required">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-sm-8 tm-btn-right">
                                        <a class="btn btn-danger" href="addUser.jsp">Empty</a>                                        
                                    </div>
                                </div>
